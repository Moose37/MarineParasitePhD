...
taxrel <- ~phylumH/classH/orderH/familyH/genusH/species #need to tell formula "as.phylo.formula" how these are all related
source("as.phylo.formula2.R") #this allows for a reworked formula for a cleaner output following taxonomic breaks
...
treefunc.psite <- function (x) {
  ...
  taxrel <- ~phylumP/classP/orderP/familyP/genusP/species #need to tell formula "as.phylo.formula" how these are all related
  source("as.phylo.formula2.R") #this allows for a reworked formula for a cleaner output following taxonomic breaks
  tree <- as.phylo.formula(taxrel, data = Sharktax, collapse = FALSE)
...
# and draw it in a specias accummulation curve
...
moda_pri <- read.csv("C:/Users/Mooseface/Google Drive/University/PhD NZ/Data_and_code/Primer/Distinctness_values.csv")
...
write_csv(FinalSet, "C:/Users/Mooseface/Google Drive/University/PhD NZ/Data_and_code/Chapt3Finalset999host.csv")
